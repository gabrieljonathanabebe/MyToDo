# mytodo/clients/api/routes/todo_summary.py
...
from mytodo.clients.api.schemas import CreateToDoRequest, ToDoSummaryResponse
...
def create_todo(username: str, body: CreateToDoRequest) -> ToDoSummaryResponse:
    services = deps.get_todo_services(username)
...
def delete_todo(username: str, todo_id: str) -> dict[str, str]:
    services = deps.get_todo_services(username)
